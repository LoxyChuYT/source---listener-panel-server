	...
	if (isInGameBO3())
	{
		...
		if (openBO3)
		{
			if (currentBO3 == BO3_MAIN)
			{
				...
				BO3_DrawText("OutHere Menu", middleBO3 + 20, centerBO3 - 1, smallFontBO3, redBO3);
				BO3_DrawText("Press D-PAD Left To ^1Close^7 OutHere Menu", 30.0f, bottomBO3, smallFontBO3, whiteBO3);
		...
		{
			BO3_DrawText("Press D-PAD Left To ^2Open^7 OutHere Menu", 30.0f, bottomBO3, smallFontBO3, whiteBO3);//Bottom shit
		}
	}
	else
	{
...
VOID BO3_Start()
{
	...
	PatchInJump((PDWORD)0x822112F0, (DWORD)BO3_CL_RenderScenehk, FALSE); //TU7/8
	HookFunctionStart((PDWORD)0x822F53C0, (PDWORD)CL_WritePacketHookStubBO3, (DWORD)CL_WritePacketHookBO3); //TU8
}
