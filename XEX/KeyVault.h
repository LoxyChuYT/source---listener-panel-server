...
typedef struct _KEY_VAULT {                     
    ...
    BYTE  ManufacturingMode[0x1];               //0x18
    BYTE  AlternateKeyVault[0x1];               //0x19
    BYTE  RestrictedPrivilegesFlags[0x1];       //0x1A
    BYTE  ReservedByte3[0x1];                   //0x1B
	...
	BYTE  Padding1[0x4];                        //0xBC
    BYTE  MoboSerialNumber[0x8];                //0xC0
    WORD  GameRegion;                           //0xC8
	BYTE  Padding2[0x6];                        //0xCA
	...
	//WORD Certsize;                              //0xB70
    XEIKA_CERTIFICATE XeikaCertificate;         //0xB70  Data Start 0xB72
